...
public class CustomerResource {
    ...
    private static final String ENTITY_NAME = "usersManagementCustomer";
    ...
    @PostMapping("/create/customerIfNotExist")
    
    public ResponseEntity<CustomerDTO> createCustomerIfNotExist(@RequestBody CustomerDTO customerDTO){
      CustomerDTO result= this.customerService.createCustomerIfNotExist(customerDTO).get();
